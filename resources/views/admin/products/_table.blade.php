        ...
        <tbody class="divide-y divide-slate-50">
                    ...
                    <div class="flex items-center justify-center gap-1">
                        ...
                        @else
                            <a href="{{ route('admin.products.show', $product) }}" title="Detail & Barcode"
                                class="p-2 bg-violet-50 border border-violet-100 text-violet-600 hover:bg-violet-100 rounded-lg transition-colors">
                            ...
                            <a href="{{ route('admin.products.edit', $product) }}" title="Edit"
                                class="p-2 bg-slate-50 border border-slate-200 text-slate-600 hover:bg-slate-100 rounded-lg transition-colors">
            ...
            <tr>
                <td colspan="7" class="px-6 py-16 text-center">
                    ...
                    <p class="text-slate-300 text-xs mt-1">Coba masukkan kata kunci pencarian atau filter yang lain.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
